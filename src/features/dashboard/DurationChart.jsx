  ...
  return (
    <ChartBox>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <PieChart>
          <Pie data={data} dataKey="value" nameKey="duration" innerRadius={85} outerRadius={110} paddingAngle={3} cx="43%">
            {data.map((d) => (
              <Cell fill={d.color} stroke={d.color} />
            ))}
          </Pie>
          <Tooltip />
          <Legend verticalAlign="center" align="right" iconType="circle" layout="vertical" width="35%" />
        </PieChart>
      </ResponsiveContainer>
    </ChartBox>
  );
